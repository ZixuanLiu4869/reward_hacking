...
class ORPO(PPO):
    ...
    def augment_reward_with_discriminator_and_transfer_action_dist_inputs(
        ...
        current_batch_copy = current_batch.copy()
        current_batch_copy[DISCRIMINATOR_REWARDS] = np.zeros_like(current_batch_copy[SampleBatch.REWARDS])

        current_batch_copy[SampleBatch.REWARDS] = (min_max_reward + current_batch_copy[DISCRIMINATOR_REWARDS])
